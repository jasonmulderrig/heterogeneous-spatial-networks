...
def main():
    ...
    ##### Load in artificial bimodal end-linked polymer network topology
    ##### configuration
    print(
        "Loading in artificial bimodal end-linked polymer network topology configuration",
        flush=True)
    ...
    ##### Calculate first set of artificial bimodal end-linked polymer
    ##### network topology descriptors
    print(
        "Calculating first set of artificial bimodal end-linked polymer network topology descriptors",
        flush=True)
    ...
    ##### Calculate second set of artificial bimodal end-linked polymer
    ##### network topology descriptors
    print(
        "Calculating second set of artificial bimodal end-linked polymer network topology descriptors",
        flush=True)
    ...
    ##### Calculate third set of artificial bimodal end-linked polymer
    ##### network topology descriptors
    print(
        "Calculating third set of artificial bimodal end-linked polymer network topology descriptors",
        flush=True)
    ...
    ##### Calculate fourth set of artificial bimodal end-linked polymer
    ##### network topology descriptors
    print(
        "Calculating fourth set of artificial bimodal end-linked polymer network topology descriptors",
        flush=True)
