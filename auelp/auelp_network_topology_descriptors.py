...
def main():
    ...
    ##### Load in artificial uniform end-linked polymer network topology
    ##### configuration
    print(
        "Loading in artificial uniform end-linked polymer network topology configuration",
        flush=True)
    ...
    ##### Calculate first set of artificial uniform end-linked polymer
    ##### network topology descriptors
    print(
        "Calculating first set of artificial uniform end-linked polymer network topology descriptors",
        flush=True)
    ...
    ##### Calculate second set of artificial uniform end-linked polymer
    ##### network topology descriptors
    print(
        "Calculating second set of artificial uniform end-linked polymer network topology descriptors",
        flush=True)
    ...
    ##### Calculate third set of artificial uniform end-linked polymer
    ##### network topology descriptors
    print(
        "Calculating third set of artificial uniform end-linked polymer network topology descriptors",
        flush=True)
    ...
    ##### Calculate fourth set of artificial uniform end-linked polymer
    ##### network topology descriptors
    print(
        "Calculating fourth set of artificial uniform end-linked polymer network topology descriptors",
        flush=True)
