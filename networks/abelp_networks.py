...
def abelp_network_nu_assignment(
    ...
    for chn in range(m):
        ...
        # segment number
        if physcl_cnstrnd_nu_min > nu_min: nu_edges[chn] = nu_max
...
def abelp_network_topology_initialization(
    ...
    l_cntr = nu_mean_p_nu_bimodal_func(p, nu_min, nu_max) * b
    ...
    mx_cmp_nu_conn_core_edges, mx_cmp_nu_conn_pb_edges = abelp_network_nu_assignment(
        rng, b, L, p, nu_min, nu_max, mx_cmp_conn_core_edges,
        mx_cmp_conn_pb_edges, mx_cmp_coords)
