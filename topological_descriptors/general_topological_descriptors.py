...
def l_arr_func(
    ...
    This function calculates the length of each supplied edge. Note that
    the length of each edge is calculated as the true spatial length,
    not the naive length present in the graph.
...
def l_cmpnts_arr_func(
    ...
    This function calculates the length components of each supplied
    edge. Note that the length of each edge is calculated as the true
    spatial length, not the naive length present in the graph.
